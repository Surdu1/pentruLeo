...
<body>
  <div class="i">
  <br>
  <div class="a" id="i1" style="margin-top:12vh "><a href="electrocasnice.php">Electrocasnice</a></div>
  <br>
  <div class="a" id="i2"style="margin-top:12vh"><a href="echipamente_sportive.php">Echipamente sportive</a></div>
  <br>
  <div class="a" id="i3" style="margin-top:12vh"><a href="it.php">IT</a></div>
  <br>
  <div class="a" id="i4" style="margin-top:12vh"><a href="unelte.php">Unelte pentru constructi</a></div>
  </div>
  <?php
  include 'header.php';
   ?>
